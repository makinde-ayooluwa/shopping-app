    ...
    <div className="profile-page">
      ...
      <div className="profile-container">
        ...
        <div className="profile-header">
          <div className="profile-avatar-section">
            ...
            <div>
              ...
              <p className="profile-id">ID: USER{Date.now().toString().slice(-6)}</p>
            </div>
          </div>
          <div className="profile-stats">
            ...
            <div className="stat-card">
              <div className="stat-number">{user.currency}{user.totalSpent}</div>
        ...
        <div className="profile-tabs">
          ...
          >
            <i className="bi bi-heart"></i> Wishlist ({wishlistProducts.length})
          </button>
          <button 
            ...
            <section className="profile-section">
              ...
              {wishlistProducts.length === 0 ? (
                <div className="empty-state">
                  ...
                  <Link to="/" className="empty-btn">Shop Now</Link>
                </div>
              ) : (
                <div className="products-grid">
                ...
                {orders.map((order) => (
                  <div key={order.id} className="order-card">
                    <div className="order-header">
                      <div>
                        <span className="order-id">#{order.tracking}</span>
                      ...
                      {order.items.slice(0,2).map((item, index) => (
                        <div key={index} className="order-item-mini">
                          ...
                          <div>
                            ...
                            <div className="item-price">Qty {item.quantity} x ${item.price}</div>
                          </div>
                        </div>
                      ))}
          ...
          {activeTab === 'account' && (
            <section className="profile-section">
              ...
              <div className="account-actions">
                <Link to="/login" className="action-btn secondary">Change Password</Link>
